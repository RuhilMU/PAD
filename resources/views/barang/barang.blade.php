...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-28 mt-10">
    <div class="flex items-center justify-between p-2" style="background:#EEF0F4">
        ...
        <button type="button" class="text-white bg-[#0090F0] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
