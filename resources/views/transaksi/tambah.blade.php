    ...
    <div class="w-full rounded-full sm:max-w-md xl:p-0">
        <div class="bg-gradient-to-b from-[#CDDAF8] to-[#E5EEFF] px-44 rounded-2xl space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6 px-10" method="POST">
                ...
                <button type="submit"
                    class="bg-[#4C7DE7] ml-28 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5">
                    Simpan</button>
            </form>
        </div>
    </div>
